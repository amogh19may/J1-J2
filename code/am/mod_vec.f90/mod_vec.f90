...
program calling_func
   ...
   integer,parameter::n_save=10000
   integer,parameter::n_eqb=10000
   integer,parameter::n_lf=100
   integer,parameter::n_q=500
   real,parameter::pi=4*atan(1.0)
   real,parameter::J2=0.7
   integer::i,j,k,l
   real :: T_arr(100)=[(i,i=1,100,1)]*0.0002+0.55
   real :: E,avK2,avK4,vor,chi,chiral,t_start,t_end
   integer::nbr_all(8,n_dim**2),latt(4,n_dim**2/4)
   real:: Q(n_dim**2),U(rel)
